...
// Essa função lê o codigo de uma msg de um socket, retorna true caso tenha sucesso e false caso de erro
...
// Lê uma porção de uma std::string de um socket, de acordo com o tamanho do primeiro char
...
// Envia uma mensagem por socket (OBS: Já inclui o comando CMD_NOVA_MSG)
